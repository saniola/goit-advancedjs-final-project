import{a as m,i as f}from"./vendor-ae6d56ab.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const t of o)if(t.type==="childList")for(const i of t.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function n(o){const t={};return o.integrity&&(t.integrity=o.integrity),o.referrerPolicy&&(t.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?t.credentials="include":o.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function r(o){if(o.ep)return;o.ep=!0;const t=n(o);fetch(o.href,t)}})();const c={domen:"https://your-energy.b.goit.study/api",FAV_KEY:"favorites"},S=(e,s=!1)=>e.length===0?'<p class="not-found-message">No results found.</p>':e.map(({_id:n,name:r,burnedCalories:o,rating:t,target:i,time:d,bodyPart:u})=>`<div class="exercises-container">
    ...
    `),r.innerHTML=o,$({params:e,pagination:r,method:n})}async function p(e){const{data:s}=await m({method:"get",url:`${c.domen}/exercises?page=1&limit=10000`,responseType:"json"}),n=4,r=s.results,o=JSON.parse(localStorage.getItem(c.FAV_KEY))??[];if(r&&o&&o.length){const t=r.filter(b=>o.includes(b._id)),i=e&&e.page?(parseInt(e.page)-1)*n:0,d=t.slice(i,i+n);document.querySelector(".content").innerHTML=S(d,!0),document.querySelector(".pagination").innerHTML="";const u=t.length>n?Math.ceil(t.length/n):1;u>1&&x({params:e,totalPages:u,method:p})}else document.querySelector(".content").innerHTML="",document.querySelector(".pagination").innerHTML=""}function E({type:e,title:s,message:n,position:r="topRight"}){switch(e){case"error":f.error({title:s,message:n,position:r});break;case"success":f.success({title:s,message:n,position:r});break;case"info":f.warning({title:s,message:n,position:r});break}}async function q(e){const s=document.querySelector(".loader-text");s.style.display="block";try{const{data:n}=await m({method:"get",url:`${c.domen}/exercises/${e}`,responseType:"json"});return n}catch{E({type:"error",title:"Server error",message:"Sorry, the exercise information was not retrieved from the server. Please refresh the page"})}finally{s.style.display="none"}}const g=document.getElementById("exerciseModal"),F=document.getElementById("closeButton");async function _(e){let s;try{s=await q(e),M(s),I(),O()}catch{showToast("error","Server error","Error fetching exercise data")}}function M(e){document.querySelector(".exercise-header h2").textContent=e.name,document.querySelector(".rating-value").textContent=e.rating.toFixed(1),document.querySelector(".exercise-image").src=e.gifUrl,document.querySelector(".exercise-image").alt=e.name,document.querySelector(".target-value-js").innerHTML=e.target,document.querySelector(".body-part-value-js").innerHTML=e.bodyPart,document.querySelector(".equipment-value-js").innerHTML=e.equipment,document.querySelector(".popularity-value-js").innerHTML=e.popularity,document.querySelector(".calories-value-js").innerHTML=`${e.burnedCalories}/${e.time} min`,document.querySelector(".exercise-description").textContent=e.description,document.querySelector("#addFavoritesButton").dataset.id=e._id,document.querySelector("#removeFavoritesButton").dataset.id=e._id,w(e.rating),T()}function w(e){document.querySelectorAll(".icon-star").forEach((s,n)=>{s.classList.toggle("empty",n>=Math.round(e))})}function T(){g.classList.remove("hidden")}function B(){g.classList.add("hidden")}function I(){F.addEventListener("click",B)}const a=document.getElementById("addFavoritesButton"),l=document.getElementById("removeFavoritesButton");function O(){a.addEventListener("click",A),l.addEventListener("click",H);let e=JSON.parse(localStorage.getItem(c.FAV_KEY))??[];const s=a.dataset.id;s&&e.includes(s)?y():h()}function A(){let e=JSON.parse(localStorage.getItem(c.FAV_KEY))??[];const s=a.dataset.id;s&&!e.includes(s)&&(e.push(a.dataset.id),localStorage.setItem(c.FAV_KEY,JSON.stringify(e)),y())}function H(){let e=JSON.parse(localStorage.getItem(c.FAV_KEY))??[];const s=l.dataset.id;if(s&&e.includes(s)){const n=e.filter(r=>r!==s);localStorage.setItem(c.FAV_KEY,JSON.stringify(n)),h()}}function h(){a.classList.remove("hidden"),l.classList.add("hidden")}function y(){a.classList.add("hidden"),l.classList.remove("hidden")}document.addEventListener("DOMContentLoaded",async()=>{p({page:1})});document.querySelector(".toggle-btn-home").classList.remove("active");document.querySelector(".toggle-btn-favorites").classList.add("active");export{x as a,S as b,c,_ as o,E as s};
//# sourceMappingURL=favorites-f05d1163.js.map
