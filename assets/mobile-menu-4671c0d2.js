import{i as E,a as y}from"./vendor-ae6d56ab.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function s(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(o){if(o.ep)return;o.ep=!0;const r=s(o);fetch(o.href,r)}})();function Y({params:e,pagination:t,method:s}){const n=Array.from(t.querySelectorAll(".button"));let o=1;n.forEach(r=>{r.addEventListener("click",a=>{r.classList.contains("active")||(o=r.dataset.page,s({...e,page:o}),n.forEach(l=>l.classList.remove("active")),r.classList.add("active")),window.innerWidth<768&&document.querySelector(".filter-title").scrollIntoView({behavior:"smooth"})})})}function w({params:e,totalPages:t,method:s}){const n=document.querySelector(".pagination");let o="";const r=Number(e.page);if(t<=1){n.innerHTML="";return}r>3&&(o+=`
  ...
  `,r+1<=t&&(o+=`
    ...
    </button>`}function z(e){return e%1?`${Math.round(e*10)/10}`:`${e}.0`}async function h(e){const t=document.querySelector(".btn-filter.active").dataset.exercise;e!=null&&e.value&&(e[t]=e==null?void 0:e.value);const s=document.querySelector(".input-search-exersises").value;e.keyword=s,R(!0);let n="?";const o=document.querySelector(".content"),r=document.querySelector(".loader-text");r.style.display="block";for(const[a,l]of Object.entries(e))n+=`${a}=${l}&`;try{const{data:a}=await y({method:"get",url:`${c.domen}/exercises${n}limit=${window.innerWidth<768?8:10}`,responseType:"json"});o.innerHTML=Q(a.results);const l=document.querySelector(".pagination");l.innerHTML="",a.totalPages>1&&w({params:e,totalPages:a==null?void 0:a.totalPages,method:h})}catch{i({type:"error",title:"Server error",message:"Sorry, the exercises information was not retrieved from the server. Please refresh the page"})}finally{r.style.display="none"}}async function U(e){const t=document.querySelector(".loader-text");t.style.display="block";try{const{data:s}=await y({method:"get",url:`${c.domen}/exercises/${e}`,responseType:"json"});return s}catch{i({type:"error",title:"Server error",message:"Sorry, the exercise information was not retrieved from the server. Please refresh the page"})}finally{t.style.display="none"}}const u=document.getElementById("addFavoritesButton"),b=document.getElementById("removeFavoritesButton");function G(){u.addEventListener("click",X),b.addEventListener("click",Z);const e=JSON.parse(localStorage.getItem(c.FAV_KEY))??[],t=u.dataset.id;t&&e.includes(t)?N():j()}function X(){const e=JSON.parse(localStorage.getItem(c.FAV_KEY))??[],t=u.dataset.id;t&&!e.includes(t)&&(e.push(u.dataset.id),localStorage.setItem(c.FAV_KEY,JSON.stringify(e)),N())}function Z(){const e=JSON.parse(localStorage.getItem(c.FAV_KEY))??[],t=b.dataset.id;if(t&&e.includes(t)){const s=e.filter(n=>n!==t);localStorage.setItem(c.FAV_KEY,JSON.stringify(s)),j()}}function j(){u.classList.remove("hidden"),b.classList.add("hidden")}function N(){u.classList.add("hidden"),b.classList.remove("hidden")}async function ee(e,t){const{data:s}=await y({method:"patch",url:`${c.domen}/exercises/${e}/rating`,responseType:"json",data:t});return s}function te(){const e=document.getElementById("modalOverlay"),t=`
  ...
  `;e.insertAdjacentHTML("beforeend",t)}function se(){return document.getElementById("ratingModal").remove()}let q,m=0;function ne(e){te(),ae(),ie(),le(e),oe()}function oe(){v().querySelector("#closeRatingButton").addEventListener("click",P)}function P(){exerciseModal.classList.remove("hidden"),re(),de(),se()}function re(){g(0),m=0,f().reset()}function g(e){v().querySelectorAll(".icon-star").forEach((o,r)=>{r<e?o.classList.remove("empty"):o.classList.add("empty")});var s=e.toFixed(1);const n=v().querySelector(".rating-value");n.textContent=s}function ae(){v().querySelectorAll(".icon-star").forEach(t=>{t.addEventListener("mouseover",()=>{const s=parseInt(t.getAttribute("data-value"),10);g(s)}),t.addEventListener("mouseout",()=>{g(m)})})}function ie(){v().querySelectorAll(".icon-star").forEach(t=>{t.addEventListener("click",()=>{m=parseInt(t.getAttribute("data-value"),10),g(m)})})}function ce(e,t){if(e.preventDefault(),m===0){i({type:"error",title:"Incorrect input",message:"Please select the rating"});return}const s=f().querySelector(".rating-form-email").value,n=f().querySelector(".rating-form-comment").value;ee(t,{rate:m,email:s,review:n}).then(()=>{P(),i({type:"success",title:"Rating submitted",message:"Thank you for leaving review!"})}).catch(r=>{console.error("Error submitting form:",r),i({type:"error",title:"Server error",message:"Error submitting rating form"})})}function le(e){q=t=>ce(t,e),f().addEventListener("submit",q)}function de(){f().removeEventListener("submit",q)}function v(){return document.getElementById("ratingModal")}function f(){return document.getElementById("ratingForm")}function ue(e){const t=document.getElementById("modalOverlay"),s=`${e.burnedCalories}/${e.time} min`,n=`
