import{c as v,i as A,a as b,b as O}from"./assets/favorites-7927c87b.js";import{i as E,a as y}from"./assets/vendor-ae6d56ab.js";function o({type:e,title:t,message:s,position:r="topRight"}){switch(e){case"error":E.error({title:t,message:s,position:r});break;case"success":E.success({title:t,message:s,position:r});break;case"info":E.warning({title:t,message:s,position:r});break}}async function j(e){const t=document.querySelector(".loader-text");t.style.display="block";try{const{data:s}=await y({method:"get",url:`${v.domen}/exercises/${e}`,responseType:"json"});return s}catch{o({type:"error",title:"Server error",message:"Sorry, the exercise information was not retrieved from the server. Please refresh the page"})}finally{t.style.display="none"}}async function H(e,t){const{data:s}=await y({method:"patch",url:`${v.domen}/exercises/${e}/rating`,responseType:"json",data:t});return s}function N(){const e=document.getElementById("modalOverlay"),t=`
